...
public class StateSubactionNodeToolProvider implements INodeToolProvider {
    ...
    private DialogDescription getExistingActionSelectionDialog() {
        ...
        var selectExistingActionUsage = this.diagramBuilderHelper.newSelectionDialogDescription()
                ...
                .noSelectionActionDescriptionExpression("Create a new " + actionKind + " action without association")
                .withSelectionActionLabelExpression("Select an existing Action to associate with the " + actionKind + " action you want to create")
                .withSelectionActionDescriptionExpression("Create a new " + actionKind + " action associated with the selected action")
                .noSelectionActionStatusMessageExpression("It will create a new " + actionKind + " action without association")
                .selectionRequiredWithoutSelectionStatusMessageExpression("Select an action to associate with the new " + actionKind + " action")
                .selectionRequiredWithSelectionStatusMessageExpression(AQLConstants.AQL + "'It will create a " + actionKind + " action associated with ' + selectedObjects->first().name")
                .optional(true);
